...
<!DOCTYPE html>
 ...
 if(!ctype_alnum($user) OR !ctype_alnum($pass)){
   ...
   $querySimpan= mysqli_query($koneksi,"INSERT INTO tbl_admin VALUES ('$kd','$nama','$jenkel','$username','$password','$jabatan')");
   ...
   if($querySimpan){
     ...
     echo "<script type='text/javascript'>
         ...
         function(isConfirm) {
           if (isConfirm) {
             window.location='$admin_url'+'adminweb.php?module=tambah_admin';
           }
         });}, 100);</script>";
   }
 }
