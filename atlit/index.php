...
<body class="skin-blue card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../admin/assets/images/background/PPLP2.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="login.php" method="POST">
                        <h3 class="box-title m-b-20">Login Atlit</h3>
                        ...
                        <div class="form-group m-b-0">
                          <div class="col-sm-12 text-center">
                              Belum melakukan pendaftaran seleksi? <a href="pendaftaran.php" class="text-info m-l-5"><b>Pendaftaran</b></a>
                          </div>
                           <a href="../" id="demo-btn-addrow" class="btn btn-circle btn-danger"><i class="icon wb-plus" aria-hidden="true"></i><<
                                </a>
                        </div>
                    </form>
