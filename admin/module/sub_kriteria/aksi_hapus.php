...
<!DOCTYPE html>
 ...
 if(!ctype_alnum($user) OR !ctype_alnum($pass)){
   ...
   $kd = $_GET['kd_sub'];
   $queryDelete= mysqli_query($koneksi,"DELETE FROM tbl_sub_kriteria WHERE kd_subkt='$kd'");
   $queryDeleteDetail=mysqli_query($koneksi,"DELETE FROM detail_sub_kriteria WHERE kd_subkt='$kd'");
   if($queryDelete && $queryDeleteDetail){
